...
## Goal
Open world card for ADS users; enable batch card operations with rate-limiting protection; support Global USD account; enhance TRON deposits with address pool
